  ...
  {:schelling-app
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"schelling_app/rendering.js"]}}
    ...
    :built-in {:render {;; The directory where rendering scripts
                        ...
                        :renderer 'schelling_app.rendering
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/schelling-app-dev.html"
                            :name "Development"
                            :out-file "schelling-app-dev.js"
                            :main 'schelling_app.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :order 4
                      :output-root :tools-public}
              :production {:uri "/schelling-app.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "schelling-app.js"
                           :main 'schelling_app.start
                           :order 5}}}})
